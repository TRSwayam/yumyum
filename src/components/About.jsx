            ...
            {activeTab === 'about' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  <ContactItem icon={<Mail className="text-pink-500" />} text="swayam352@gmail.com" />
                  <ContactItem icon={<Phone className="text-pink-500" />} text="+91 9392739170" />
                  <ContactItem icon={<Github className="text-pink-500" />} text="github.com/TRSwayam/yumyum" />
